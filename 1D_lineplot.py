...
arguments = {
            'folder'        : '/Users/ttamfa/Desktop/TESTUNGROSSBI/TEST2_MPI/',
            'nghost'        : 2,
            'xmax'          : 256,
            'ymax'          : 256,
	    ...
	    'fontsize'      : 30, 
            'line_width'    : 5.0,
            'name'          : 'dustsurfacedensity',
            'value_name'    : r'$\sum_i ^n \Sigma_d / n$',
            'value_label'   : '',
            'value_label2'  : '',
            'value_label3'  : '',
            'value_label4'  : '',
...
def loopover(loop,arguments):
    ...
    rpf.plot_singlelineplot(loop, arguments, data_stat['r'], data_stat['theta'], data['rosp']*arguments['sig_ref'])

loopover(1,arguments)
